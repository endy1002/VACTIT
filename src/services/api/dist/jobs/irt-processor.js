...
exports.processIRTForExam = processIRTForExam;
 ...
 */
async function processIRTForExam(prisma, testId, redis) {
    ...
    try {
        ...
        (0, logger_1.logExternalApi)('irt-r-service', '/calculate-irt', response.status, fetchDuration, { testId });
        if (!response.ok) {
        ...
        for (const studentId of studentIds) {
            await (0, notification_routes_1.createNotification)(prisma, redis || null, {
        ...
        (0, logger_1.logPerformance)('irt_direct_processing', totalDuration, 30000, {
            testId,
